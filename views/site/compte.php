	...
	<div class="container">
		<div class="row">
			<div class="col-lg-9 order-lg-last dashboard-content">
				...
				<h3>INFORMATION DE MON COMPTE</h3>
				<div class="row">
					<div class="col-md-6">
						<div class="card">
						...
						<div class="checkout-discount">
							<h2 class="step-title">
								<a data-toggle="collapse" href="#edit-account" class="collapsed card-edit btn btn-sm btn-outline-info float-right" role="button">
									CHANGER LES INFORMATION DE VOTRE COMPTE
								</a>
							</h2>
							<div class="collapse" id="edit-account">
							<form action="" method="post"  action="<?= Yii::$app->request->baseUrl.'/'.md5('login_compte')?>"> 
			...
			<aside class="sidebar col-lg-3">
				<div class="widget widget-dashboard">
					...
					<ul class="list">
						...
						<li><a href="<?= Yii::$app->request->baseUrl.'/'.md5("site_changepassword") ?>">Change de Mots de passe</a></li>
						<!-- 
						=*= FOR LATER USED ONLY =*=
