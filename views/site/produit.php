									...
									<?php
										foreach($relatedResult AS $eachImage)
										{
											...
											<div class="product-item">
												<img class="product-single-image" src="'. Yii::$app->request->baseUrl."/web/public/uploads/products/"  . $eachImage['product_master_image'] .'"
												data-zoom-image="'. Yii::$app->request->baseUrl."/web/public/uploads/products/"  . $eachImage['product_master_image'] .'">
											</div>									
											';
										}
									?>
								...
								<?php
									foreach($relatedResult AS $eachImage)
									{
										...
										<div class="col-3 owl-dot">
											<img src="'. Yii::$app->request->baseUrl."/web/public/uploads/products/"  . $eachImage['product_master_image'] .'"/>
										</div>										
										';
									}
								?>
							...
							<div class="product-single-details">
								...
								<div class="price-box">
									<span class="product-price">
										...
										<?php
											#== PRODUCT PRICE
											echo Yii::$app->params['CURRENCY'] . " " . $productResult[0]['product_price'];
										?>
			...
			<aside class="sidebar-product col-lg-3 padding-left-lg mobile-sidebar">
				<div class="sidebar-wrapper">
					<div class="widget widget-brand">
						<a href="#">
							<img src="<?= yii::$app->request->baseUrl?>/web/public/assets/images/favicon/brandlogoFrontEnd.png" alt="brand name" style="height: 86px; width: 76px;">
						</a>
					</div>
										...
										<div class="product product-sm">
											<figure class="product-image-container">
												<a href="product.php" class="checkouts-image">
													<img src="<?= Yii::$app->request->baseUrl."/web/public/uploads/products/"  . $eachFeatured['product_master_image'] ?>" alt="product">
												</a>
											</figure>
											<div class="product-details">
												...
												<div class="price-box">
													<span class="product-price"><?= Yii::$app->params['CURRENCY'] . " " . $eachFeatured['product_price'] ?></span>
												</div>
											</div>
										</div>
							...
							<div class="product">
								<figure class="product-image-container">
									<a href="product.php?id=' .$eachrelevantProduct['id'] . ' " class="products-image">
										<img src=" '. Yii::$app->request->baseUrl."/web/public/uploads/products/"  . $eachrelevantProduct['product_master_image'] .' " alt="product">
									</a>
								...
								<div class="product-details">
									...
									<div class="price-box">
										<span class="product-price">'. Yii::$app->params['CURRENCY'] . " " . $eachrelevantProduct['product_price'] .'</span>
									</div>
