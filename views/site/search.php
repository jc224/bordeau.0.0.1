...
<main class="main">
	<div class="banner banner-cat" style="background-image: url('<?= Yii::$app->request->baseUrl?>/web/public/assets/images/newsletter_popup_bg.jpg');">
	...
	<nav aria-label="breadcrumb" class="breadcrumb-nav">
		<div class="container">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="search.php">Rechercher</a></li>
			</ol>
		</div>
	</nav>
	<div class="container">
							...
							if(!empty($searchedProductList))
							{
								...
								{	
									...
									if(empty($eachProduct['product_master_image'])) {
										...
										$productImage = Yii::$app->request->baseUrl."/web/public/uploads/products/" . $eachProduct['product_master_image'];
									}
									echo '
