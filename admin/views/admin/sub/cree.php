	...
	<div class="row">
		<div class="col-lg-12">
           <ul class="breadcrumb panel">
				...
				<li> <a href="dashboard.php"> SOUS CATEGORIE </a> </li>
			...
			<section class="panel">
				...
				<div class="panel-body">
					...
					<div class="form">
						<form class="form-horizontal" id="subCategory" method="post" action="<?=Yii::$app->request->baseUrl.'/'.md5('admin_subcategorie') ?>" enctype="multipart/form-data">
                        <input type="hidden" name="_csrf" value="'.Yii::$app->request->getCsrfToken().'"/>

                           <div class="form-group ">
								<label for="SubCategoryName" class="control-label col-lg-2">Libelle</label>
								<div class="col-lg-7">
									<input class="form-control" id="subcategory_name" name="subcategory_name" type="text" />
								</div>
							</div>
							<div class="form-group ">
								<label for="CategoryName" class="control-label col-lg-2">Liebelle Categorie</label>
								<div class="col-lg-7">
							...
							<div class="form-group">
								<label for="SubCatBanner" class="control-label col-md-2 ">  Banner </label>
							...
							<div class="form-group last">
								<label for="BannerPreview" class="control-label col-md-2"> Apercue Banner</label>
								<div class="col-md-9">
									<div class="fileupload fileupload-new" data-provides="fileupload">
							...
							<div class="form-group ">
								<label for="SubCategoryStatus" class="control-label col-lg-2"> Status </label>
								<div class="col-lg-7">
							...
							<div class="form-group">
								<div class="col-lg-offset-2 col-lg-10">
									<button name="create_subcategory" class="btn btn-success" type="submit"> Enregistrer </button>
									<button class="btn btn-default" type="reset"> Modifier </button>
								</div>
							</div>
						</form>
					</div>
