...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 08 mai 2023 à 03:05
...
(1, 'HOMME', 'Inactive', NULL, NULL),
(2, 'FEMME', 'Inactive', NULL, NULL),
...
(11, 'Electronique', 'Active', NULL, NULL),
(12, 'Electronique', 'Active', NULL, NULL),
(13, 'Electronique', 'Active', NULL, NULL);
...
(1, 'EID FESTIVAL COLLECTION 2020', 'SLIDER_20200706022816_slide852r.jpg', 'Inactive', 1, NULL, NULL),
(2, 'HOME DECOR', 'SLIDER_20200706022832_slider.jpg', 'Inactive', 2, NULL, NULL),
(3, 'PAHELA BAISHAK COLLECTION 202', 'SLIDER_20230508012322_SUBCATBANNER_20200706024527_banner(4).jpg', 'Active', 3, NULL, NULL),
...
(17, 'Nouvelle arivage', 'SLIDER_20230508000146_Capture.PNG', 'Active', 1, NULL, NULL);
...
(25, 1, 'autre', 'Active', 'SUBCATBANNER_20230508025916_SUBCATBANNER_20200706025140_banner(9).jpg', '2023-05-08 02:59:16', NULL),
(26, 1, 'autre', 'Active', 'SUBCATBANNER_20230508030005_SUBCATBANNER_20200706025140_banner(9).jpg', '2023-05-08 03:00:05', NULL),
(27, 1, 'autre', 'Active', 'SUBCATBANNER_20230508030020_SUBCATBANNER_20200706025140_banner(9).jpg', '2023-05-08 03:00:20', NULL),
(28, 1, 'autre', 'Active', 'SUBCATBANNER_20230508030112_SUBCATBANNER_20200706025140_banner(9).jpg', '2023-05-08 03:01:12', NULL),
(29, 1, 'autre', 'Active', 'SUBCATBANNER_20230508030209_SUBCATBANNER_20200706025140_banner(9).jpg', '2023-05-08 03:02:09', NULL),
(30, 1, 'autre', 'Active', 'SUBCATBANNER_20230508030246_SUBCATBANNER_20200706025140_banner(9).jpg', '2023-05-08 03:02:46', NULL);
...
--
ALTER TABLE `categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'CATEGORIES ID', AUTO_INCREMENT=14;
...
--
ALTER TABLE `slides`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'SLIDER ID', AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT pour la table `subcategories`
--
ALTER TABLE `subcategories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'SUBCATEGORIES ID', AUTO_INCREMENT=31;
